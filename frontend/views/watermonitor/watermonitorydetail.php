	 ...
	 <table border="1" cellspacing="0" bordercolor="#3498db" cellpadding="5" width="90%" bgcolor="#666666" align="center">
		<tbody>
			...
			<tr bgcolor="#f5fafa">
				...
				<td nowrap="nowrap" colspan="2"><?=trim($model['img1'])?></td>
			</tr>
			<tr bgcolor="#f5fafa">
				<td rowspan="9" nowrap="nowrap" width="30%">
					<div id="img1"><img src="<?php echo Yii::getAlias('@web');?>/public/rtuimgs/<?=trim($model['current_site'])?>/<?=trim($model['img1'])?>" class="img-indent" style="width:70%;height:70%;"/></div>
					<div id="img2" style="display:none;"><img src="<?php echo Yii::getAlias('@web');?>/public/rtuimgs/<?=trim($model['current_site'])?>/<?=trim($model['img2'])?>" class="img-indent" style="width:80%;height:80%;"/></div>
				</td>
