		...
		<tbody>
			<tr bgcolor="#f5fafa">
				<td style="font-size: 22px" bgcolor="#a0d3e0" height="40" colspan="8" align="center"><strong>水位监测</strong></td>
   		       ...
   		       <tr bgcolor="#f5fafa">
				<td nowrap="nowrap">
	                        <?=$model['site']?>&nbsp;&nbsp;<a href='#' onclick="javascript:test(1,1);"><img src="<?php echo Yii::getAlias('@web');?>/public/images/img1.png"></a>&nbsp;&nbsp;<a href='#' onclick="javascript:test(1,2);"><img src="<?php 
                                  echo Yii::getAlias('@web');?>/public/images/img2.png"></a>
				</td>
				<td nowrap="2" colspan="2"><?=trim($model['img1'])?></td>
			</tr>

			<tr bgcolor="#f5fafa">
				<td rowspan="9" nowrap="nowrap" width="15%" heigth = "200%" >
