...
<table border="1" cellspacing="0" bordercolor="#3498db" cellpadding="5" width="90%" bgcolor="#666666" align="center">
	<tbody>
		<tr bgcolor="#f5fafa">
			<td nowrap="nowrap">
				<?=$dagaList[1]?>&nbsp;&nbsp;<a href='#' onclick="javascript:imageSwitcher('<?=$dagaList[0]?>','<?php echo Yii::getAlias('@web');?>/public/images/<?=trim($dagaList[8])?>');"><img src="<?php echo Yii::getAlias('@web');?>/public/images/img1.png"></a>&nbsp;&nbsp;
				<a href='#' onclick="javascript:imageSwitcher('<?=$dagaList[0]?>','<?php echo Yii::getAlias('@web');?>/public/images/<?=trim($dagaList[9])?>');"><img src="<?php echo Yii::getAlias('@web');?>/public/images/img2.png"></a>
			</td>
			<td nowrap="nowrap" colspan="2"><?=$dagaList[2]?>&nbsp;&nbsp;<?=$dagaList[3]?></td>
			<td rowspan="6" nowrap="nowrap">&nbsp;</td>
			<td nowrap="nowrap">
				<?=$dagaList2[1]?>&nbsp;&nbsp;<a href='#' onclick="javascript:imageSwitcher('<?=$dagaList2[0]?>','<?php echo Yii::getAlias('@web');?>/public/images/<?=trim($dagaList2[8])?>');");"><img src="<?php echo Yii::getAlias('@web');?>/public/images/img1.png"></a>&nbsp;&nbsp;
				<a href='#' onclick="javascript:imageSwitcher('<?=$dagaList2[0]?>','<?php echo Yii::getAlias('@web');?>/public/images/<?=trim($dagaList2[9])?>');");"><img src="<?php echo Yii::getAlias('@web');?>/public/images/img2.png"></a>
			</td>
		...
		<tr bgcolor="#f5fafa">
			...
			<?php
				if($dagaList[8]!=""){
			?>
				<div id="dimg<?=$dagaList[0]?>"><img src="<?php echo Yii::getAlias('@web');?>/public/images/<?=trim($dagaList[8])?>" alt="" class="img-indent" style="width:100%;height:100%;"/></div>
			<?php
				}else{
			?>
			...
			<td rowspan="5" nowrap="nowrap" width="30%">
				<?php
					if($dagaList2[8]!=""){
				?>
					<div id="dimg<?=$dagaList2[0]?>"><img src="<?php echo Yii::getAlias('@web');?>/public/images/<?=trim($dagaList2[8])?>" alt="" class="img-indent" style="width:100%;height:100%;"/></div>
				<?php
					}else{
				?>
