	 ...
	 <table border="1" cellspacing="0" bordercolor="#3498db" cellpadding="5" width="90%" bgcolor="#666666" align="center">
		<tbody>
			...
			<tr bgcolor="#f5fafa">
				...
				<td nowrap="nowrap" colspan="2">test</td>
			</tr>
			<tr bgcolor="#f5fafa">
				<td rowspan="9" nowrap="nowrap" width="30%">
					<div id="img1"><img src="<?php echo Yii::getAlias('@web');?>/public/images/<?=trim($model['img1'])?>" class="img-indent" style="width:100%;height:100%;"/></div>
					<div id="img2" style="display:none;"><img src="<?php echo Yii::getAlias('@web');?>/public/images/<?=trim($model['img2'])?>" class="img-indent" style="width:100%;height:100%;"/></div>
				</td>
				<td nowrap="nowrap" width="10%"><p >时间</p></td>
				<td nowrap="nowrap" width="10%"><?=$model['datetime']?></td>
			</tr>
			<tr bgcolor="#f5fafa">
				<td nowrap="nowrap"><p >当前站号</p></td>
