...
<script type="text/javascript"> 
 ...
 //         setTimeout(showTime, 1000);
     ...
     <img src="<?php echo Yii::getAlias('@web');?>/public/backgroundimg/skimg.png" style="width:100%; position:absolute;right:0px;bottom:0px;z-index:0;">
<div class="water-monitor-index" style="z-index:1;position:absolute;">

    <h1><?= Html::encode($this->title) ?></h1>
    <p>
         <?=Html::beginForm(['/waterMonitor/watermonitor/calltest','id'=>$rtutablename]);?>
  ...
  <!--         <input name="open_date" id="y_open" style="width:190px;" type="text" onclick="javascript:showTime()" value="点击更新时间" readonly="true" >
      -->
             <br/>
              ...
              <!--= Html::a('召测', ['remotecallrtu','id' => $rtutablename], ['class' => 'btn btn-success'])-->
             
               <?= Html::a('召测', ['remotedelay','id' => $rtutablename], ['class' => 'btn btn-success' ])?> 
